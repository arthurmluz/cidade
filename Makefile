...
PROG = main
FONTES = app/Ponto.cpp app/Cor.cpp app/Poligono.cpp app/Temporizador.cpp app/ListaDeCoresRGB.cpp app/Instancia.cpp  util/movimentos.cpp app/Modelo.cpp util/ImageClass.cpp util/TextureClass.cpp util/Objetos3D.cpp main.cpp 
